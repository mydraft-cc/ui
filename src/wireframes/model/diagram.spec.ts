...
describe('Diagram', () => {
    const shape1 = DiagramShape.createShape(MathHelper.guid(), 'btn', 100, 20);
    const shape2 = DiagramShape.createShape(MathHelper.guid(), 'btn', 100, 20);
    const shape3 = DiagramShape.createShape(MathHelper.guid(), 'btn', 100, 20);

    const diagram_1 = Diagram.empty(MathHelper.guid());
    ...
    it('should remove children when removing group', () => {
        ...
        const diagram_4 = diagram_3.group(MathHelper.guid(), [shape1.id, shape2.id]);
    ...
    it('should update visual in items', () => {
        const oldShape = DiagramShape.createShape(MathHelper.guid(), 'btn', 100, 20);
    ...
    it('should return original diagram when less than 2 shapes to be grouped are found', () => {
        const diagram_2 = diagram_1.addVisual(shape1);
        const diagram_3 = diagram_2.addVisual(shape2);
        const diagram_4 = diagram_3.group(MathHelper.guid(), [shape1.id, 'INVALID']);
