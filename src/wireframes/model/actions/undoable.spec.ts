...
describe('Undoable', () => {
    ...
    it('should call state for undo action', () => {
        ...
        const reducer = undoable((s, a) => { reducerCalled = true; return s; }, 20, {}, []);
    ...
    it('should call inner reducer for other action', () => {
        ...
        const reducer = undoable((s, a) => { reducerCalled = true; return 16; }, 20, {}, []);
        const state_2 = reducer(state_1, { type: 'OTHER' });
    ...
    it('should call inner reducer for ignored action', () => {
        ...
        const reducer = undoable((s, a) => { reducerCalled = true; return 16; }, 20, {}, ['OTHER']);
        const state_2 = reducer(state_1, { type: 'OTHER' });
