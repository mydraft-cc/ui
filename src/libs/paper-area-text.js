...
/*
 * js - The Swiss Army Knife of Vector Graphics Scripting.
 * http://paperjs.org/
 *
 ...
 */
  ...
  * @name AreaText
  *
  * @class An AreaText item represents a piece of typography in your js
  * project which starts from a certain point and extends by the amount of
  * characters contained in it.
  *
  * @extends TextItem
  */
paper.AreaText = paper.TextItem.extend(/** @lends AreaText# */{
   _class: 'AreaText',
   ...
   setRectangle: function(/* rectangle */) {
       var rectangle = paper.Rectangle.read(arguments);
   ...
   _updateAnchor: function() {
     var justification = this._style.getJustification(),
         ...
         anchor = new paper.Point(0,this._style.getFontSize());
